...
//##begin##"header declarations"
			static int TowersOfHanoi_start_counter;
			static Chronograph TowersOfHanoi_start_chronograph;
			static int TowersOfHanoi_playNDisks_counter;
			static Chronograph TowersOfHanoi_playNDisks_chronograph;
			static int TowersOfHanoi_moveDisk_counter;
			static Chronograph TowersOfHanoi_moveDisk_chronograph;
			static int TowersOfHanoi_displayGame_counter;
			static Chronograph TowersOfHanoi_displayGame_chronograph;
